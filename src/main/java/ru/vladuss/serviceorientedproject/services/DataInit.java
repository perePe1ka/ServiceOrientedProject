...
public class DataInit implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Orders orders1 = new Orders(null, "Customer 5", "Address 5", Status.NO_STATUS, 1000, null);
        Orders orders2 = new Orders(null, "Customer 6", "Address 6", Status.NO_STATUS, 2000, null);
        Orders orders3 = new Orders(null, "Customer 7", "Address 7", Status.NO_STATUS, 3000, null);
        Orders orders4 = new Orders(null, "Customer 8", "Address 8", Status.NO_STATUS, 4000, null);
